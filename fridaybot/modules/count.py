...
#     b = 0 # number of bots
#     await friday.tr_engine(event, "Retrieving Telegram Count(s)")
...
#     await friday.tr_engine(event, """Obtained in {} seconds.
# Users:\t{}
# Groups:\t{}
# Super Groups:\t{}
# Channels:\t{}
...
async def stats(
    ...
    await friday.tr_engine(event, "`Collecting stats, Wait Master`")
    ...
    await friday.tr_engine(event, response)
